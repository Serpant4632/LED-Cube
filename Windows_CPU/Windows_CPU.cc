...
// Compile command
// g++ -g -o Windows_CPU Windows_CPU.cpp -std=c++11 -lbrcmEGL -lbrcmGLESv2 -I/opt/vc/include -L/opt/vc/lib -L../lib -lrgbmatrix -lrt -lm -lpthread -lstdc++ -I../include/
...
#define T1 50.0 //Do not omit the decimal point. This will be used in the OpenGL shader which will otherwise interpret it as a float literal
#define T2 70.0
#define T3 90.0
